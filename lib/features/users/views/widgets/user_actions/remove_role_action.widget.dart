...
class _RemoveRoleActionState extends State<RemoveRoleAction> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.roleInfo.hasAnyRole
        ? BlocProvider(
                ...
                switch (state) {
                  ...
                  case UpdateFailure():
                    ...
                    switch (state.code) {
                      ...
                      case 'active-groups':
                        message =
                            'Nie udało się usunąć roli, użytkownik jest ostatnim członkiem zespołu posiadającego przypisane aktywne króliki.';
                        break;
                      default:
                        message = 'Nie udało się usunąć roli';
                    }
